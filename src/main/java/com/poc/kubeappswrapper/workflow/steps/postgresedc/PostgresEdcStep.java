package com.poc.kubeappswrapper.workflow.steps.postgresedc;
...
@Component
@Scope("thread")
public class PostgresEdcStep extends Task {
    ...
    public void run() {
        ...
        appManagement.createPackage(POSTGRES_DB, tenantName + "" + packagefor,
                    inputData);
        inputData.put("edcdatabaseurl", jdbcUrl);
