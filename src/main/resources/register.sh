...
if [ -n "$CERTFILE" ]; then
    ...
    openssl req -newkey rsa:2048 -new -nodes -x509 -days 3650 -text -keyout "keys/${CLIENT_NAME}.key" -out "keys/${CLIENT_NAME}.crt" -config openssl.cnf
